...
print(sum_max_two_values(*explode(",",input("Введите 2 числа через запятую: "),3))) #превращает строку в массив с ограничением 3 значения массива, и показывает сумму 2 больших чисел
